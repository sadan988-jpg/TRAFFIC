...
def generate_net_xml(out_dir: Path) -> Path:
    """
    Programmatically construct a high-density 4-way urban intersection.

    Lane layout per arm (3 lanes):
        Lane 0 — Left-turn only
        Lane 1 — Straight only
        Lane 2 — Straight + Right-turn  (shared)

    Nodes:
        J0  = central intersection
        N/S/E/W = perimeter endpoints  (200 m arms)

    Edge speed limit: 13.89 m/s  (≈ 50 km/h urban arterial)
    """
    path = out_dir / "ecosync.net.xml"

    # ------------------------------------------------------------------
    # TLS logic string  (12-state cycle matching 3-lane geometry)
    #   Green for N↔S straight/right  =  GGGrrr GGGrrr
    #   Green for E↔W straight/right  =  rrrGGG rrrGGG
    #   Left-turn protected phases appended per arm
    # ------------------------------------------------------------------
    tls_phases = """
        <phase duration="35" state="GGGrrrGGGrrrrrrrrrrrrrr"/>
        <phase duration="5"  state="YYYrrrYYYrrrrrrrrrrrrrr"/>
        <phase duration="20" state="rrrGGGrrrGGGrrrrrrrrrrr"/>
        <phase duration="5"  state="rrrYYYrrrYYYrrrrrrrrrrr"/>
        <phase duration="15" state="rrrrrrrrrrrrGGGrrrGGGrrr"/>
        <phase duration="5"  state="rrrrrrrrrrrrYYYrrrYYYrrr"/>
        <phase duration="15" state="rrrrrrrrrrrrrrrrrrrrrrGGG"/>
        <phase duration="5"  state="rrrrrrrrrrrrrrrrrrrrrrYYY"/>"""

    xml = textwrap.dedent(f"""\
    <?xml version="1.0" encoding="UTF-8"?>
    <!--
        EcoSync  |  4-Way Urban Intersection  |  3 Lanes per Arm
        Auto-generated by ecosync_sim.py — DO NOT EDIT MANUALLY
    -->
    <net version="1.16" junctionCornerDetail="5"
      ...
      <!-- ── Locations ── -->
      <location netOffset="0.00,0.00" convBoundary="-250,-250,250,250"
                origBoundary="-250,-250,250,250" projParameter="!"/>

      <!-- ── Edge Types ── -->
      <type id="urban_arterial" priority="12" numLanes="3"
            speed="13.89" allow="all" disallow="pedestrian"/>
      <type id="urban_arterial_rev" priority="12" numLanes="3"
            speed="13.89" allow="all" disallow="pedestrian"/>
      ...
      <!-- Central intersection — controlled by Traffic Light System J0_tls -->
      <node id="J0" x="0" y="0" type="traffic_light"
            tl="J0_tls" tlType="static" tlLayout="opposites"
            rightOfWay="edgePriority"/>

      <!-- ══════════════════════════════════════
           EDGES  (bidirectional, 3 lanes each)
           ══════════════════════════════════════ -->
      <!-- North arm -->
      <edge id="N_in"  from="N_end" to="J0"   type="urban_arterial"
            numLanes="3" speed="13.89" spreadType="center"/>
      <edge id="N_out" from="J0"   to="N_end" type="urban_arterial"
            numLanes="3" speed="13.89" spreadType="center"/>

      <!-- South arm -->
      <edge id="S_in"  from="S_end" to="J0"   type="urban_arterial"
            numLanes="3" speed="13.89" spreadType="center"/>
      <edge id="S_out" from="J0"   to="S_end" type="urban_arterial"
            numLanes="3" speed="13.89" spreadType="center"/>

      <!-- East arm -->
      <edge id="E_in"  from="E_end" to="J0"   type="urban_arterial"
            numLanes="3" speed="13.89" spreadType="center"/>
      <edge id="E_out" from="J0"   to="E_end" type="urban_arterial"
            numLanes="3" speed="13.89" spreadType="center"/>

      <!-- West arm -->
      <edge id="W_in"  from="W_end" to="J0"   type="urban_arterial"
            numLanes="3" speed="13.89" spreadType="center"/>
      <edge id="W_out" from="J0"   to="W_end" type="urban_arterial"
            numLanes="3" speed="13.89" spreadType="center"/>
      ...
      <!-- ══════════════════════════════════════
           ...
           Lane 0 = Left-turn only
           Lane 1 = Straight only
           Lane 2 = Straight + Right (shared)
           ══════════════════════════════════════ -->
      <lane id="N_in_0"  index="0" speed="13.89" length="200" allow="all"/>
      <lane id="N_in_1"  index="1" speed="13.89" length="200" allow="all"/>
      <lane id="N_in_2"  index="2" speed="13.89" length="200" allow="all"/>
      <lane id="S_in_0"  index="0" speed="13.89" length="200" allow="all"/>
      <lane id="S_in_1"  index="1" speed="13.89" length="200" allow="all"/>
      <lane id="S_in_2"  index="2" speed="13.89" length="200" allow="all"/>
      <lane id="E_in_0"  index="0" speed="13.89" length="200" allow="all"/>
      <lane id="E_in_1"  index="1" speed="13.89" length="200" allow="all"/>
      <lane id="E_in_2"  index="2" speed="13.89" length="200" allow="all"/>
      <lane id="W_in_0"  index="0" speed="13.89" length="200" allow="all"/>
      <lane id="W_in_1"  index="1" speed="13.89" length="200" allow="all"/>
      <lane id="W_in_2"  index="2" speed="13.89" length="200" allow="all"/>

      <!-- ══════════════════════════════════════
           CONNECTIONS  (turn mappings at J0)
           ══════════════════════════════════════ -->
      <!-- N_in → outputs  (lane 0=left→E, lane 1=straight→S, lane 2=right/straight) -->
      <connection from="N_in" to="E_out" fromLane="0" toLane="1" dir="l" state="o"/>
      <connection from="N_in" to="S_out" fromLane="1" toLane="1" dir="s" state="o"/>
      <connection from="N_in" to="S_out" fromLane="2" toLane="2" dir="s" state="o"/>
      <connection from="N_in" to="W_out" fromLane="2" toLane="2" dir="r" state="o"/>

      <!-- S_in → outputs -->
      <connection from="S_in" to="W_out" fromLane="0" toLane="1" dir="l" state="o"/>
      <connection from="S_in" to="N_out" fromLane="1" toLane="1" dir="s" state="o"/>
      <connection from="S_in" to="N_out" fromLane="2" toLane="2" dir="s" state="o"/>
      <connection from="S_in" to="E_out" fromLane="2" toLane="2" dir="r" state="o"/>

      <!-- E_in → outputs -->
      <connection from="E_in" to="N_out" fromLane="0" toLane="1" dir="l" state="o"/>
      <connection from="E_in" to="W_out" fromLane="1" toLane="1" dir="s" state="o"/>
      <connection from="E_in" to="W_out" fromLane="2" toLane="2" dir="s" state="o"/>
      <connection from="E_in" to="S_out" fromLane="2" toLane="2" dir="r" state="o"/>

      <!-- W_in → outputs -->
      <connection from="W_in" to="S_out" fromLane="0" toLane="1" dir="l" state="o"/>
      <connection from="W_in" to="E_out" fromLane="1" toLane="1" dir="s" state="o"/>
      <connection from="W_in" to="E_out" fromLane="2" toLane="2" dir="s" state="o"/>
      <connection from="W_in" to="N_out" fromLane="2" toLane="2" dir="r" state="o"/>

      <!-- ══════════════════════════════════════
           TRAFFIC LIGHT LOGIC
           ══════════════════════════════════════ -->
      <tlLogic id="J0_tls" type="static" programID="EcoSync_v1" offset="0">
        {tls_phases}
      </tlLogic>
    ...
    log.info("✅  net.xml written → %s", path)
    return path
...
def generate_rou_xml(
    ...
    <routes xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
      ...
      <vType id="bus" accel="1.2" decel="3.0" sigma="0.3"
             ...
             emissionClass="HBEFA4/Bus_urban_diesel_Euro-VI"
             personCapacity="60"/>
      ...
      <vType id="moto" accel="3.2" decel="5.0" sigma="0.6"
             ...
             emissionClass="HBEFA4/MR_petrol_Euro-4"
             personCapacity="2"/>
